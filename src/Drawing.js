...
class Drawing
{
    ...
    {
        this.activeLayer.addShape(this._assignHandle(new Line(x1, y1, z1, x2, y2, z2)));
        return this;
    }
    ...
    {
        this.activeLayer.addShape(this._assignHandle(new Arc(x1, y1, z1, r, startAngle, endAngle, normal)));
        return this;
    }
    ...
    {
        this.activeLayer.addShape(this._assignHandle(new Circle(x1, y1, z1, r, normal)));
        return this;
    }
    ...
    drawText(x1, y1, z1, height, rotation, value, nor, horizontalAlignment = 'left', verticalAlignment = 'baseline')
    {
        this.activeLayer.addShape(this._assignHandle(
            new Text(x1, y1, z1, height, rotation, value, nor, horizontalAlignment, verticalAlignment)));
        return this;
    }
    ...
    {
        const p = new Polyline(points, closed, nor, elevation, startWidth, endWidth);
